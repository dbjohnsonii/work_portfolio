...
set wrap off
set termout off
spo \\amscifs01\homefolders$\djohnson\Desktop\visa_misuse.txt
SELECT 
...
AND co.IIN=cc.BIN
WHERE pa.statusdate BETWEEN TO_DATE('4/01/2018','MM/DD/YYYY') AND TO_DATE('4/30/2018','MM/DD/YYYY')
AND pa.statusid in (525,600)
and paymentproductid=1
